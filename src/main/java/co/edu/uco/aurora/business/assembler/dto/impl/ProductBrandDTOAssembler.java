...
public final class ProductBrandDTOAssembler implements DTOAssembler<ProductBrandDTO, ProductBrandDomain> {
    ...
    public ProductBrandDTO toDTO(final ProductBrandDomain domain) {
        ...
        var productSizeDtoTmp = UnitMeasurementDTOAssembler.getProductSizeDTOAssembler().toDTO(domainTmp.getUnitMeasurement());
    ...
    public ProductBrandDomain toDomain(final ProductBrandDTO dto) {
        ...
        var productSizeDomainTmp = UnitMeasurementDTOAssembler.getProductSizeDTOAssembler().toDomain(dtoTmp.getUnitMeasurement());
